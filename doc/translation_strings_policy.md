...
This document provides guidelines for internationalization of the Turbocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `turbocoin_en.ts` remains unchanged.
