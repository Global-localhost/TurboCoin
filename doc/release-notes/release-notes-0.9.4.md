Turbocoin Core version 0.9.4 is now available from:

  https://turbocoin.us/bin/0.9.4/
...
this update is incompatible with the Turbocoin system and could lead to consensus
forks.

Turbocoin Core released binaries from https://turbocoin.us are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~turbocoin/+archive/ubuntu/turbocoin
- A third-party or self-compiled Turbocoin Core

upgrade to Turbocoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
