Turbocoin Core version 0.16.1 is now available from:

  <https://turbocoincore.org/bin/turbocoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting turbocoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure turbocoind processes are cleaned up when tests end (sdaftuar)
