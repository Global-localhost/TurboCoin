Turbocoin Core version 0.10.4 is now available from:

  <https://turbocoin.us/bin/turbocoin-core-0.10.4/>
...
- #6953 `43c2789` Split turbocoin-tx into its own package
- #6953 `dfe0d4d` Include turbocoin-tx binary on Debian/Ubuntu
