Turbocoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/turbocoin/files/Turbocoin/turbocoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Turbocoin
...
New/changed settings (command-line or turbocoin.conf file)
--------------------------------------------------------
