Turbocoin Core version 0.13.2 is now available from:

  <https://turbocoin.us/bin/turbocoin-core-0.13.2/>
...
- #8908 `4a974b2` Update turbocoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow turbocoin-tx to create v2 transactions (btcdrak)
