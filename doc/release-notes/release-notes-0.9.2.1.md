Turbocoin Core version 0.9.2.1 is now available from:

  https://turbocoin.us/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TURBO to 0.01 TURBO
...
- Fix "Start turbocoin on system login"
