 ...
 *  A CTxDestination is the internal data type encoded in a turbocoin address
 */
...
/**
 * Generate a Turbocoin scriptPubKey for the given CTxDestination. Returns a P2PKH
