...
enum WalletFlags : uint64_t {
    ...
    //! turbocoin from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Turbocoin Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this turbocoin node, and set to 0 for transactions that were created
