    ...
    mapper(nullptr)
{
    ...
    ui->turbocoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->turbocoinAtStartup);
    ...
    ui->turbocoinAtStartup->setToolTip(ui->turbocoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->turbocoinAtStartup->setText(ui->turbocoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openTurbocoinConfButton->setToolTip(ui->openTurbocoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new TurbocoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->turbocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTurbocoinConfButton_clicked()
{
