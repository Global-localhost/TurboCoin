...
/** Turbocoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TurbocoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TurbocoinUnits(QObject *parent);

    /** Turbocoin units.
      @note Source: https://en.turbocoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TURBO,
...
typedef TurbocoinUnits::Unit TurbocoinUnit;
