...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, TurbocoinUnits::SeparatorStyle separators=TurbocoinUnits::separatorStandard) const;
