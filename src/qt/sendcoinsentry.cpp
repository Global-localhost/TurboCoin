    ...
    platformStyle(_platformStyle)
{
    ...
    // normal turbocoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying turbocoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &TurbocoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
