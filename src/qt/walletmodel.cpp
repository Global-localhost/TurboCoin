...
#endif
        {   // User-entered turbocoin address / amount:
...
#endif
            if (!rcp.message.isEmpty()) // Message from normal turbocoin:URI (turbocoin:123...?message=example)
...
bool WalletModel::bumpFee(uint256 hash, uint256& new_hash)
{
    ...
    questionString.append(TurbocoinUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), old_fee));
    questionString.append("</td></tr><tr><td>");
    questionString.append(tr("Increase:"));
    questionString.append("</td><td>");
    questionString.append(TurbocoinUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), new_fee - old_fee));
    questionString.append("</td></tr><tr><td>");
    questionString.append(tr("New fee:"));
    questionString.append("</td><td>");
    questionString.append(TurbocoinUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), new_fee));
