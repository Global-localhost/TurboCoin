...
//! Entry point for TurbocoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &TurbocoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for TurbocoinGUI tests.
void AppTests::guiTests(TurbocoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &TurbocoinGUI::consoleShown, this, &AppTests::consoleTests);
