...
static void SetupTurbocoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " turbocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  turbocoin-tx [options] <hex-tx> [commands]  Update hex-encoded turbocoin transaction\n" +
            "or:     turbocoin-tx [options] -create [commands]   Create hex-encoded turbocoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded turbocoin transaction
