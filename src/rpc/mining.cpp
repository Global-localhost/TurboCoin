        ...
        throw std::runtime_error(
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated turbocoin to."},
            ...
            + "If you are running the turbocoin core wallet, you can get a new address to send the newly generated turbocoin to with:\n"
...
// NOTE: Unlike wallet RPC (which use TURBO values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            RPCHelpMan{"getblocktemplate",
                ...
                "    https://github.com/turbocoin/bips/blob/master/bip-0022.mediawiki\n"
                "    https://github.com/turbocoin/bips/blob/master/bip-0023.mediawiki\n"
                "    https://github.com/turbocoin/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
                "    https://github.com/turbocoin/bips/blob/master/bip-0145.mediawiki\n",
                {
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2) {
        throw std::runtime_error(
            RPCHelpMan{"submitblock",
                ...
                "See https://en.turbocoin.it/wiki/BIP_0022 for full specification.\n",
                {
