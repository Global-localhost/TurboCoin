...
By default, turbocoind will dump mempool on shutdown and
...
class MempoolPersistTest(TurbocoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent turbocoind from writing mempool.dat to disk. Verify that `savemempool` fails")
