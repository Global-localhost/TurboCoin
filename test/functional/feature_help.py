...
"""Verify that starting turbocoin with -h works as expected."""

from test_framework.test_framework import TurbocoinTestFramework
from test_framework.util import assert_equal

class HelpTest(TurbocoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start turbocoin with -h for help text")
        ...
        self.log.info("Start turbocoin with -version for version information")
        ...
        self.log.info("Start turbocoind with -fakearg to make sure it does not start")
