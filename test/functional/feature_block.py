...
class FullBlockTest(TurbocoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure turbocoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure turbocoind isn't accepting b28
        ...
        # turbocoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the turbocoin code has custom code which does so);
