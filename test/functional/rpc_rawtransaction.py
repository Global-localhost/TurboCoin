...
class RawTransactionsTest(TurbocoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Turbocoin address", self.nodes[0].createrawtransaction, [], {'foo': 0})
        ...
        # 1000 sat fee, ~200 b transaction, fee rate should land around 5 sat/b = 0.00005000 TURBO/kB
