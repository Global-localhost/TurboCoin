...
"""Check that it's not possible to start a second turbocoind instance using the same datadir or wallet."""
import os

from test_framework.test_framework import TurbocoinTestFramework
from test_framework.test_node import ErrorMatch

class FilelockTest(TurbocoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Check that we can't start a second turbocoind instance using the same datadir")
        ...
        if self.is_wallet_compiled():
            ...
            self.log.info("Check that we can't start a second turbocoind instance using the same wallet")
