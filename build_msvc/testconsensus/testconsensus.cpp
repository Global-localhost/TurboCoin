...
// turbocoin includes.
#include <..\src\script\turbocoinconsensus.h>
...
int main()
{
    std::cout << "turbocoinconsensus version: " << turbocoinconsensus_version() << std::endl;
    ...
    auto op0Result = turbocoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, turbocoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
